...
`pingmq` is available [here](https://github.com/button-chen/surgemq/tree/master/cmd/pingmq) and documentation is available at [godoc](http://godoc.org/github.com/button-chen/surgemq/cmd/pingmq). It utilizes [surge/ping](https://github.com/surge/ping) to perform the pings.
